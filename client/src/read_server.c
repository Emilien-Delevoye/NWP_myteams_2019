...
{
    event_loggedin, event_loggedout, event_pv_mes_rx, event_th_mes_rx,
    event_team_created, event_channel_created, event_thread_created,
    print_users, print_teams, team_print_channels, channel_print_threads,
    thread_print_replies, pv_msg_print_msg, error_unk_team, error_unk_channel,
    error_unk_thread, error_unk_user, error_unauthorized,
    error_already_exist, print_user, print_team, print_channel,
    print_thread, print_team_created, print_channel_created,
    print_thread_created, print_reply_created, print_client_subscribed,
